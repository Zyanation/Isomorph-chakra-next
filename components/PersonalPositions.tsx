...
export const PersonalPositions = ({account, _LoanDisplay, _PostedDisplay, ethersToNum}) => {
  return (
    <div>
...
<Thead>
                ...
                <Tbody>
                  ...
                  :
                    ...
                    <Td><Text><StatNumber>{_PostedDisplay && ethersToNum(_PostedDisplay)} sUSD</StatNumber></Text></Td>
